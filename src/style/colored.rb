  ...
  module Creat
    ...
    module Slipstick
      ...
      COLORED = {
        ...
        Entity::LABEL    => Io::Creat::SVG_STYLE.merge( { :"font-size" => 2.4, :fill => '#971c1c', :"font-weight" => 'bold' } ),
        ...
        Entity::BRANDING => Io::Creat::SVG_STYLE.merge( { :"text-anchor" => 'middle', :stroke => '#971c1c' } ),
