...
sheet = Io::Creat::Slipstick::Layout::Sheet.new( 287, 200, 10, 5, 20 )

  sheet.create_label( "LOGAREX 27403-II: L P K A | B CI C | D S T ST" )
  # LOGAREX 27403-II
  strip = sheet.create_strip( 21.0, 250.0, 10.0, 10.0, 7.0 )
    #scale = strip.create_scale( Io::Creat::Slipstick::ScaleType::LIN_DECIMAL, "", 0 )
    #  scale.set_params( 25 )
    scale = strip.create_scale( Io::Creat::Slipstick::ScaleType::LIN_DECIMAL, "log x", 0.33, true )
      scale.set_params( 10 )
    scale = strip.create_scale( Io::Creat::Slipstick::ScaleType::TGN_PYTHAG, "√(1-x²)", 0.33, true )
      scale.set_style( Io::Creat::Slipstick::Style::SMALL )
      scale.set_params( )
    scale = strip.create_scale( Io::Creat::Slipstick::ScaleType::LOG_DECIMAL, "x³", 0.33, true )
      scale.set_style( Io::Creat::Slipstick::Style::SMALL )
      scale.set_params( 3 )
      scale.set_flags( 0 )
      scale.add_constants( )
  ...
  strip = sheet.create_strip( 16.0, 250.0, 10.0, 10.0, 7.0 )
    scale = strip.create_scale( Io::Creat::Slipstick::ScaleType::LOG_DECIMAL, "x²", 0.5 )
      scale.set_params( 2 )
      scale.set_overflow( 3.0 )
      scale.add_constants( )
  ...
  strip = sheet.create_strip( 21.0, 250.0, 10.0, 10.0, 7.0 )
    scale = strip.create_scale( Io::Creat::Slipstick::ScaleType::LOG_DECIMAL, "x", 0.5 )
      scale.set_params( 1 )
      scale.add_constants( )
    scale = strip.create_scale( Io::Creat::Slipstick::ScaleType::TGN_SIN, "sin", 0.33, false )
      scale.set_style( Io::Creat::Slipstick::Style::SMALL )
      scale.set_params( 90, 5, [ 1, 5, 10, 20 ] )
      scale.set_flags( 0 )
    scale = strip.create_scale( Io::Creat::Slipstick::ScaleType::TGN_TAN, "tan", 0.33, false )
      scale.set_style( Io::Creat::Slipstick::Style::SMALL )
      scale.set_params( 45, 5, [ 1, 5, 10, 20 ] )
      scale.set_flags( 0 )
    scale = strip.create_scale( Io::Creat::Slipstick::ScaleType::TGN_SINTAN, "s-t", 0.33, false )
      scale.set_style( Io::Creat::Slipstick::Style::SMALL )
