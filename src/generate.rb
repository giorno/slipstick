...
sheet = Io::Creat::Slipstick::Layout::Sheet.new( 287, 200, 10, 5, 20 )
  ...
  # LOGAREX 27403-II
  strip = sheet.create_strip( 24.0, 250.0, 10.0, 10.0, 7.0 )
    #scale = strip.create_scale( Io::Creat::Slipstick::ScaleType::LIN_DECIMAL, "", 0 )
    #  scale.set_params( 25 )
    scale = strip.create_scale( Io::Creat::Slipstick::ScaleType::LIN_DECIMAL, "log x", 0, true )
      scale.set_params( 10 )
    scale = strip.create_scale( Io::Creat::Slipstick::ScaleType::TGN_PYTHAG, "√(1-x²)", 30.0, true )
  ...
  strip = sheet.create_strip( 18.0, 250.0, 10.0, 10.0, 7.0 )
  ...
  strip = sheet.create_strip( 24.0, 250.0, 10.0, 10.0, 7.0 )
    scale = strip.create_scale( Io::Creat::Slipstick::ScaleType::LOG_DECIMAL, "x", 30.0 )
      scale.set_params( 1 )
      scale.add_constants( )
    scale = strip.create_scale( Io::Creat::Slipstick::ScaleType::TGN_SIN, "sin", 30.0, false )
      scale.set_style( Io::Creat::Slipstick::Style::SMALL )
      scale.set_params( 90, 5, [ 1, 5, 10, 20 ] )
      scale.set_flags( 0 )
    scale = strip.create_scale( Io::Creat::Slipstick::ScaleType::TGN_TAN, "tan", 30.0, false )
      scale.set_style( Io::Creat::Slipstick::Style::SMALL )
      scale.set_params( 45, 5, [ 1, 5, 10, 20 ] )
      scale.set_flags( 0 )
    scale = strip.create_scale( Io::Creat::Slipstick::ScaleType::TGN_SINTAN, "s-t", 30.0, false )
      scale.set_style( Io::Creat::Slipstick::Style::SMALL )
