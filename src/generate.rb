...
sheet = Io::Creat::Slipstick::Layout::Sheet.new( )
  ...
  # LOGAREX 27403-II
  strip = sheet.create_strip( 25.0, 250.0, 10.0, 15.0, 15.0 )
    ...
    scale = strip.create_scale( Io::Creat::Slipstick::ScaleType::LOG_DECIMAL, "x²", 0, true )
      scale.set_params( 2 )
      #scale.set_overflow( 3 )
      scale.add_constants( )

  strip = sheet.create_strip( 15.0, 250.0, 10.0, 15.0, 15.0 )
    scale = strip.create_scale( Io::Creat::Slipstick::ScaleType::LOG_DECIMAL, "x²", 0 )
      scale.set_params( 2 )
  ...
  strip = sheet.create_strip( 20.0, 250.0, 10.0, 15.0, 15.0 )
