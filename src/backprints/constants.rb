...
module Io::Creat::Slipstick
  module Backprints
    ...
    class ConstantsBackprint < Backprint
      MATH = [ [ 'imaginary',             'i²', "-1" ],
               [ 'Meissel–Mertens',       'M₁', "\u00a00.261497212847642784" ],
               [ 'Omega',                  'Ω', "\u00a00.567143290409783872" ],
               [ 'Euler-Mascheroni',       'γ', "\u00a00.577215664901532861" ],
               [ 'Apéry',                  'ζ', "\u00a01.202056903159594285" ],
               [ 'Pythagoras',       "\u221b2", "\u00a01.414213562373095049" ],
               [ 'Ramanujan-Soldner',      'μ', "\u00a01.451369234883381050" ],
               [ 'Golden ratio',           'φ', "\u00a01.618033988749894848" ],
               [ 'Theodorus',        "\u221b3", "\u00a01.732050807568877294" ],
               [ '',                 "\u221b5", "\u00a02.236067977499789696" ],
               [ 'Euler',                  'e', "\u00a02.718281828459045235" ],
               [ 'Archimedes',             'π', "\u00a03.141592653589793238" ],
               [ 'recipr. Fibonacci',      'ψ', "\u00a03.359885666243177553" ],
             ]
