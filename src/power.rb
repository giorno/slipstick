...
module Io::Creat::Slipstick
  ...
  class PowerXScale < PowerScale
    VALUES = [ 2.5, 2.6, 2.7, 2.8, 2.9, 3.0, 3.5, 4.0, 4.5, 5.0, 6.0, 7.0, 8.0, 9.0, 10.0, 15.0, 20.0, 25.0, 30.0, 40.0, 50.0, 100.0, 150.0, 200.0, 300.0, 400.0, 500.0, 700.0, 800.0, 900.0, 1000.0, 2000.0, 3000.0, 4000.0, 5000.0, 10000.0, 20000.0, 30000.0 ]
    FODDERS = {   2.5 => [ 5,  [ 6 ] ],
                  3.0 => [ 10, [ 2 ] ],
                  5.0 => [ 10, [ 5 ] ],
                 10.0 => [ 10, [ 2 ] ],
               ...
               5000.0 => [ 10, [ 2 ] ],
              20000.0 => [ 5,  [ 5 ] ], }
    SMALL = [ 2.5, 2.6, 2.7, 2.8, 2.9, 3.5, 4.5, 700.0, 800.0, 900.0 ]
    NOLABEL = [ 150.0, 700.0, 800.0, 900.0 ]
  end # PowerXScale
