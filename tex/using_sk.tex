...
\begin{document}
  ...
  \nosection{}
  \large\textbf{\makeperex Tento návod popisuje ako používať papierové Logaritmické pravítko označené ako \modelname.}
...
Bežec sa nachádza na indexe \constt{1.175} na stupnici, čo je výsledok operácie.

  \textbf{Stá odmocnina}
\constt{5\textsuperscript{0.01}:}
Posuň Bežec na index 5 na stupnici LL3.
Bežec sa nachádza na indexe \constt{0.982} na stupnici LL1, čo je výsledok operácie.
