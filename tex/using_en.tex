...
\begin{document}
  ...
  \begin{center}
    \headingfont\fontsize{32}{32}\selectfont HOW TO USE THE SLIDE RULE
  \end{center}
...
%  {\let\newpage\relax\maketitle}% no new line before title
  ...
  On the \textbf{back of the Stock} there are located \textbf{tables of mathematical and physical constants}, and other useful graphics\footnote{The metric and inch scales on the back of the Stock and on the front of the Cursor may not be accurate due to temperatures used by the printer and humidity during glueing that alter the paper properties and dimensions.}, but those are not directly involved in calculations.

The Slide contains, besides the logarithmic scales on both sides, conversion ratios between imperial and metric (SI) units. The inside of the Slide contains conversion scales for \textbf{deg-rad-grad} angle units and \textbf{hex-dec-oct-bin} bases.
  ...
  \input{opst.tex}
  \makesectiontitle{Basic Multiplication}
...
\normalsize
  ...
  \makesectiontitle{Wrap-around Multiplication}
...
Adjusting decimal place gives the result: \constt{11.05}. 
  ...
  \makesectiontitle{Basic Division}
...
The Cursor is now at index 5.97. The correct answer is near 4 / 8 = 0.5. Adjusting decimal place gives the result: \constt{0.597}.
  ...
  \makesectiontitle{Reciprocal Value}
...
The correct answer is near 1 / 10 = 0.1. Adjusting decimal place gives the result: \constt{0.1132}.
  ...
  \makesectiontitle{Square Number}
...
The correct answer is between 10 and 20 as 10\textsuperscript{3} = 1000 and 20\textsuperscript{3} = 8000. Adjusting decimal place gives the result: \constt{16.55}.
  ...
  \makesectiontitle{Raising to Power of 10}
...
The Cursor is now at \constt{21.5} on the scale LL3, which is the result.
  ...
  \makesectiontitle{10\textsuperscript{th} Root}
...
The Cursor is now at index \constt{1.175} on the scale LL2, which is the result.
  ...
  \makesectiontitle{Raising to Power of 100}
...
The correct answer is between 0.1 and 1. Adjusting decimal place gives the result: \constt{0.65}.
  ...
  \makesectiontitle{Logarithm of Base 10}
