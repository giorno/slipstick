...
\begin{document}
  ...
  On the back of the Stock there are tables of mathematical and physical constants, and other useful graphics, but they are not involved in calculations. The Slide contains, besides the logarithmic scales on both sides, conversion ratios between imperial and metric (SI) units.

  The Slide slides inside the Stock and the Cursor slides on the top of the Stock. By sliding these parts, aligning the scales to appropriate positions and reading them, mathematical operations are performed.
...
The correct answer is between 0.1 and 1. Adjusting decimal place gives the result: \constt{0.545}.
  ...
  \textbf{Cosine}
\footnotesize Use scale S for finding cosine of angles between 5\textdegree and 90\textdegree, and scale ST for angles between 30' and 6\textdegree. \normalsize
