...
\newcommand{\makeperex}{Logaritmické pravítko je analógový počítač - zariadenie, ktoré dokáže počítať väčšinu základných a niektoré pokročilé matematické operácie. Nie je síce také presné a nepoužíva sa tak jednoducho ako elektronická kalkulačka, ale elegantne demonštruje matematické zákony. Je to historický artefakt, ktorý bol ešte pred päťdesiatimi rokmi bežne používaný v technických disciplínach, inžinieri a astronauti ním počas vesmírnych misií dokonca počítali trajektórie a letové parametre. }
